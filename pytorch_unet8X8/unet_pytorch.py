...
def test(model):
    ...
    save_dir = "/home/npovey/data/pytorch_unet8X8/test"
    ...
    for i in range(9):
        ...
        with torch.no_grad():
            for idx in range(num_batches):
                ...
                # save images as .flt files                                                                                                                                                             
        save_dir = "/home/npovey/data/pytorch_unet8X8/denoised_images"
...
def train(model):
    ...
    PATH = "/home/npovey/data/pytorch_unet8X8/unet_weights.pth"
    # -------validation data -----
    ...
    np.save('/home/npovey/data/pytorch_unet8X8/losses', losses)
    np.save('/home/npovey/data/pytorch_unet8X8/psnrs', psnrs)
    end = time.time()
...
# the line below must stay uncommented unless for some reason we need to denoise all training images
# denoise_all(model)
torch.cuda.empty_cache()
