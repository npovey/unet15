...
from keras.layers import Subtract,Activation
...
#     c11 = Conv2D(8, (3, 3), activation='relu', padding='same') (c1)
#     p1 = MaxPooling2D((2, 2)) (c11)
#
#     c2 = Conv2D(16, (3, 3), activation='relu', padding='same') (p1)
#     c21 = Conv2D(16, (3, 3), activation='relu', padding='same') (c2)
#     p2 = MaxPooling2D((2, 2)) (c21)
#
#     c3 = Conv2D(32, (3, 3), activation='relu', padding='same') (p2)
#     c31 = Conv2D(32, (3, 3), activation='relu', padding='same') (c3)
#     p3 = MaxPooling2D((2, 2)) (c31)
#
#     c4 = Conv2D(64, (3, 3), activation='relu', padding='same') (p3)
#     c41 = Conv2D(64, (3, 3), activation='relu', padding='same') (c4)
#     p4 = MaxPooling2D(pool_size=(2, 2)) (c41)
#
#     c5 = Conv2D(128, (3, 3), activation='relu', padding='same') (p4)
#     c51 = Conv2D(128, (3, 3), activation='relu', padding='same') (c5)
#
#     u6 = Conv2DTranspose(64, (2, 2), strides=(2, 2), padding='same') (c51)
#     u61 = concatenate([u6, c41])
#     c6 = Conv2D(64, (3, 3), activation='relu', padding='same') (u61)
#     c61 = Conv2D(64, (3, 3), activation='relu', padding='same') (c6)
#
#     u7 = Conv2DTranspose(32, (2, 2), strides=(2, 2), padding='same') (c61)
#     u71 = concatenate([u7, c31])
#     c7 = Conv2D(32, (3, 3), activation='relu', padding='same') (u71)
#     c71 = Conv2D(32, (3, 3), activation='relu', padding='same') (c7)
#
#     u8 = Conv2DTranspose(16, (2, 2), strides=(2, 2), padding='same') (c71)
#     u81 = concatenate([u8, c21])
#     c8 = Conv2D(16, (3, 3), activation='relu', padding='same') (u81)
#     c81 = Conv2D(16, (3, 3), activation='relu', padding='same') (c8)
#
#     u9 = Conv2DTranspose(8, (2, 2), strides=(2, 2), padding='same') (c81)
#     u91 = concatenate([u9, c11])
#     c9 = Conv2D(8, (3, 3), activation='relu', padding='same') (u91)
#     c91 = Conv2D(8, (3, 3), activation='relu', padding='same') (c9)
#     output_img = Conv2D(1, (3, 3), padding='same') (c91)
