# main.py
# (base) [npovey@ka U-Net-Denoiser-master]$ rm ldct_eval_data.tfrecord ldct_train.tfrecord ndct_train.tfrecord ndct_eval_data.tfrecord
# (base) [npovey@ka U-Net-Denoiser-master]$ rm -r test/ save/ checkpoints/ output_samples/
# (base) [npovey@ka U-Net-Denoiser-master]$ source activate myenv
# (myenv) [npovey@ka U-Net-Denoiser-master]$ python3 main.py

# (keras-gpu) [npovey@ka unet6]$ screen -S unet
# unet15(with batch normalization and bias=False)
# sparseview_60: Avg PSNR: 33.28Avg SSIM: 0.8858
# sparseview_90:

# unet14 (with batch normalization)
# sparseview_60:  Avg PSNR: 33.12 Avg SSIM: 0.8823
# sparseview_90:   Avg PSNR: 35.45Avg SSIM: 0.9043
# sparseview_180: Avg PSNR: 39.28 Avg SSIM: 0.9303
# ldct_1e5:       Avg PSNR: 42.16 Avg SSIM: 0.9444
# ldct_2e5:       Avg PSNR: 42.70 Avg SSIM: 0.9466
# ldct_7e4:       Avg PSNR: 41.75 Avg SSIM: 0.9426

# unet6 (same as unet14 but without batch normalization)
# sparseview_60:  Avg PSNR: 33.26 Avg SSIM: 0.8851
# sparseview_90:  Avg PSNR: 35.53 Avg SSIM: 0.9042
# sparseview_180: Avg PSNR: 39.44 Avg SSIM: 0.9315
# ldct_1e5:
# ldct_2e5:
# ldct_7e4:
"""
...
parser.add_argument('--batch-size', default=30, type=int, help='Batch size')
